...
\begin{frame}[fragile]{Why implementing from scratch? }
    ...
    \redb{Our goal was correctnes and highest possible throughput and low latency.} 
...
\begin{frame}[fragile]{Two Implementations in Python and Java }

    \url{https://github.com/kiat/debs2022/}
