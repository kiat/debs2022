...
%% article.
\begin{abstract}
  High-performance monitoring of the stock market data stream is one of the challenging use cases of the data stream 
  processing systems. 
Different continuous queries can be defined by market brokers to provide buy and sell advice. 
