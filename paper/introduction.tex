...
\begin{itemize}
    ...
    \item These systems are designed for higher scalability rather than higher stream throughput/latency performance for a specific data stream. They  implement their internal data processing pipelines 
