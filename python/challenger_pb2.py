...
Indicator = _reflection.GeneratedProtocolMessageType(
    "Indicator",
    (_message.Message,),
    {
...
ResultQ1 = _reflection.GeneratedProtocolMessageType(
    "ResultQ1",
    (_message.Message,),
    {
...
CrossoverEvent = _reflection.GeneratedProtocolMessageType(
    "CrossoverEvent",
    (_message.Message,),
    {
...
ResultQ2 = _reflection.GeneratedProtocolMessageType(
    "ResultQ2",
    (_message.Message,),
    {
...
BenchmarkConfiguration = _reflection.GeneratedProtocolMessageType(
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _SECURITYTYPE._serialized_start = 979
    _SECURITYTYPE._serialized_end = 1016
    _QUERY._serialized_start = 1018
    _QUERY._serialized_end = 1041
    _EVENT._serialized_start = 95
    _EVENT._serialized_end = 241
    _BATCH._serialized_start = 243
    _BATCH._serialized_end = 339
    _BENCHMARK._serialized_start = 341
    _BENCHMARK._serialized_end = 364
    _INDICATOR._serialized_start = 366
    _INDICATOR._serialized_end = 426
    _RESULTQ1._serialized_start = 428
    _RESULTQ1._serialized_end = 525
    _CROSSOVEREVENT._serialized_start = 528
    _CROSSOVEREVENT._serialized_end = 742
    _CROSSOVEREVENT_SIGNALTYPE._serialized_start = 711
    _CROSSOVEREVENT_SIGNALTYPE._serialized_end = 742
    _RESULTQ2._serialized_start = 744
    _RESULTQ2._serialized_end = 852
    _BENCHMARKCONFIGURATION._serialized_start = 854
    _BENCHMARKCONFIGURATION._serialized_end = 977
    _CHALLENGER._serialized_start = 1044
    _CHALLENGER._serialized_end = 1436
